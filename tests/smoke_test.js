...
check('department operation batch persistence', code.includes('function batchCreateDepartmentOperationRows(') && appHtml.includes("callServer('batchCreateDepartmentOperationRows'") && appHtml.includes('operation-batch-add'), 'department multi-row save is incomplete');
